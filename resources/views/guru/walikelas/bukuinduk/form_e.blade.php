{{-- DATA E --}}
<tr>
	<td colspan="4" style="font-size: 12pt;">E. KETERANGAN TENTANG AYAH KANDUNG : </td>
</tr>
<tr>
	<td></td>
...
<tr>
	...
	<td>: 
		<input type="text" name="tmp_ayah" value="{!! (!empty($bukuinduk)) ? strtoupper($bukuinduk->tmp_ayah) : '' !!}">
		<input type="date" name="tgl_ayah" value="{!! (!empty($bukuinduk)) ? strtoupper($bukuinduk->tgl_ayah) : '' !!}">
	</td>
</tr>
<tr>
	<td></td>
...
<tr>
	...
	<td>: 
		...
		$nilai = (!empty($bukuinduk)) ? $bukuinduk->pengeluaran_ayah : ''
		?>
		<select name="pengeluaran_ayah">
...
<tr>
	...
	<td>:
		...
		$nilai = (!empty($bukuinduk)) ? $bukuinduk->status_ayah : ''
		?>
