...
<div class="row">
			...
			<div class="col-lg-3 col-md-3 col-sm-12 xol-xs-12">
				<div class="card card-info">
					...
					<div class="card-body" style="background: #ccc">
						...
						<input type="number" class="form-control" name="uh[]" value="{{$nilai->proyek}}" @if($nilai->is_kunci==true) readonly @endif>
						@else
	...
	<div style="width: 100%">
		<a style="width: 100%" href="javascript:void(0)" class="btn btn-primary btn-lg" @if($mengajar->is_kunci==true) onclick="alert('Pengisian nilai sudah dikunci')" @else onclick="simpankd('uh','proyek')" @endif>Simpan</a>
	</div>
</div>