...
<div class="row">
	...
	<div style="width: 100%">
		<a style="width: 100%" href="javascript:void(0)" class="btn btn-primary btn-lg" @if($mengajar->is_kunci==true) onclick="alert('Pengisian nilai sudah dikunci')" @else onclick="simpankd('uh','nph')" @endif>Simpan</a>
	</div>
</div>