...
<label class="label_rapor">B. Pengetahuan dan Keterampilan</label>
<table class="kontent_rapor" style="width: 100%;border-collapse: collapse;" border="1">
	<tr style="background: #ddd;">
...
<label class="label_rapor">F. Ketidakhadiran</label>
...
$nomor = 1;
?>
<label class="label_rapor">G. Deskripsi Pengetahuan dan Keterampilan</label>
<table class="kontent_rapor" style="width: 100%;border-collapse: collapse;" border="1">
	<tr style="background: #ddd;">
	...
	<tr>
		...
		<td rowspan="2">{{$v->mapel}}<br><i style="font-size: 10px">{{$v->guru_mengajar}}</i></td>
		<td style="text-align: center">Pengetahuan</td>
		<td style="text-align: justify;">{{$v->deskripsi_ki3}}</td>
	</tr>
	<tr>
		<td style="text-align: center">Keterampilan</td>
		<td style="text-align: justify;">{{$v->deskripsi_ki4}}</td>
	</tr>
	<?php $nomor++;?>
	@endforeach
	@endif
...
<label class="label_rapor">A. Perkembangan Fisik/ Kesehatan</label>
<table class="kontent_rapor" style="width: 100%;border-collapse: collapse;" border="1">
...
<label class="label_rapor">B. Kondisi Kesehatan</label>
<table class="kontent_rapor" style="width: 100%;border-collapse: collapse;" border="1">
	<tr style="background: #ddd;text-align: center;">
		<th rowspan="2">No</th>
		<th rowspan="2">Aspek yang dinilai</th>
...
<label class="label_rapor">C. Catatan Prestasi</label>
<table class="kontent_rapor" style="width: 100%;border-collapse: collapse;" border="1">
	<tr style="background: #ddd;text-align: center;">
		<th>No</th>
